	...
	public void doExecute(Environment env, Map params,
		...
		if (isPage) {
			...
			Page<Info> pagedList = query.findPage(nodeId, attrId, specialId,
					tagId, siteId, mainNodeId, userId, treeNumber,
					specialTitle, tagName, priority, startDate, endDate, title,
			...
			List<Info> list = query.findList(nodeId, attrId, specialId, tagId,
					siteId, mainNodeId, userId, treeNumber, specialTitle,
					tagName, priority, startDate, endDate, title, includeId,
					excludeId, excludeMainNodeId, excludeTreeNumber,
