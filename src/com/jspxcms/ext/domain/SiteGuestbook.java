...
public class SiteGuestbook implements Configurable {
	public static final String PREFIX = "guestbook_";
	/**
	 * 关闭留言
	 */
	 ...
	 */
	public static final String MODE = "guestbook_mode";
	/**
	 * 审核模式。0：关闭审核，1：游客需审核，2：游客和会员需审核，3：游客、会员、管理员都需审核
	 */
	public static final String AUDIT_MODE = "guestbook_auditMode";
	/**
	 * 验证码模式。0：关闭验证码，1：游客需验证码，2：游客和会员需验证码，3：游客、会员、管理员都需验证码
	 */
	public static final String CAPTCHA_MODE = "guestbook_captchaMode";
	/**
	 * 留言最大长度
	 */
	public static final String MAX_LENGTH = "guestbook_maxLength";
