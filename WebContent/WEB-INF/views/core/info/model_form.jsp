...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    ...
    <td class="in-ctt" width="85%" colspan="3">
	    <f:text id="customs_template" name="customs_template" value="${bean.customs['template']}" class="required" style="width:160px;"/><input id="customs_templateButton" type="button" value="F7"/>
	    <script type="text/javascript">
	    $(function(){
