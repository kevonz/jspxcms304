...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="admin.management"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  <tr>
    <td colspan="4" class="in-opt">
			<shiro:hasPermission name="core:admin:create">
			...
			<shiro:hasPermission name="core:admin:copy">
			...
			<shiro:hasPermission name="core:admin:delete">
  ...
  <tr>
    ...
    <td class="in-ctt" width="85%" colspan="3">
	    <f:hidden id="orgId" name="orgId" value="${bean.org.id}"/>
	    <f:hidden id="orgIdNumber" value="${bean.org.id}"/>
	    <f:hidden id="orgIdName" value="${bean.org.displayName}"/>
	    <f:text id="orgIdNameDisplay" value="${bean.org.displayName}" class="required" readonly="readonly" style="width:350px;"/><input id="orgIdButton" type="button" value="F7"/>
	    <script type="text/javascript">
	    $(function(){
  ...
  <tr>
    ...
    <td class="in-ctt" width="85%" colspan="3"><f:checkboxes name="roleIds" items="${roleList}" checked="${bean.roles}" itemLabel="name" itemValue="id"/></td>
  </tr>
  <tr>
