...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="admin.management"/> - <s:message code="list"/></span>
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls-tb margin-top5">
  ...
  <tr<shiro:hasPermission name="core:admin:edit"> ondblclick="location.href=$('#edit_opt_${bean.id}').attr('href');"</shiro:hasPermission>>
    ...
    <td>
	    <c:forEach var="role" items="${bean.roles}" varStatus="status">
