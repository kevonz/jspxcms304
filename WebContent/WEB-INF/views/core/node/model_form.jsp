...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    ...
    <td class="in-ctt" width="35%">
    	<f:text id="customs_coverTemplate" name="customs_coverTemplate" value="${bean.customs['coverTemplate']}" class="required" maxlength="255" style="width:160px;"/><input id="customs_coverTemplateButton" type="button" value="F7"/>
	    <script type="text/javascript">
	    $(function(){
    ...
    <td class="in-ctt" width="35%">
    	<f:text id="customs_listTemplate" name="customs_listTemplate" value="${bean.customs['listTemplate']}" maxlength="255" style="width:160px;"/><input id="customs_listTemplateButton" type="button" value="F7"/>
	    <script type="text/javascript">
	    $(function(){
  ...
  <tr>
    ...
    <select name="customs_staticMethod" class="required">
      ...
      <f:option value="3" selected="${bean.customs['staticMethod']}" default="3"><s:message code="node.staticMethod.3"/></f:option>
    </select>
    </td>
