...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    ...
    <td class="in-ctt" colspan="3"><f:text name="username" value="${oprt=='edit' ? bean.username : ''}" class="{required:true,remote:'check_username.do?original=${oprt=='edit' ? bean.username : ''}'}" style="width:180px;"/></td>
  </tr>
  <tr>
