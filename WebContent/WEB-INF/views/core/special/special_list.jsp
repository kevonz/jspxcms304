...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  ...
	  <label class="c-lab"><s:message code="startTime"/>: <f:text name="search_GTE_creationDate_Date" value="${search_GTE_creationDate_Date[0]}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" style="width:80px;"/></label>
